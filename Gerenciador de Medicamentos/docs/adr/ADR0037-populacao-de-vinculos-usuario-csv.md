...
Substituído pelo [ADR-0053](ADR0053-remocao-do-terminal-e-do-csv-gui-como-cliente-da-api.md) (`UsuarioCsvAdapter` foi removido; no PostgreSQL os vínculos vêm do próprio banco)
